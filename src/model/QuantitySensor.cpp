...
model::QuantitySensor::QuantitySensor(const QString& identifier, const QDateTime& created, const int val,const int max) : Sensor(identifier, created), value(val), max_value(max){};
